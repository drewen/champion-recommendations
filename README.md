...
![Header Image](public/icons/header.png "What Champion Should You Play?")
...
* You can’t get negative amounts of champion mastery points when you play a game, so champion mastery points are only additive—just play a champion enough and you’ll eventually get a high mastery. Champion masteries don’t necessarily say how skilled you are at a champion, just that you enjoy playing it enough to play multiple times. 
...
We also acknowledged that this information is only useful to a player if it’s about someone else, or if it can be used to tell them more about their own play style. Because there are plenty of inferences that people already make by looking up their opponents online, we chose to focus on telling people more about their play style. Continuing along with this, we realized that this would have to be something that targeted newer or intermediate players as advanced players probably know enough about their own play style to know what champions they like playing, or they’ve tested out a multitude of champions to come to those same conclusions. This helped us narrow our focus to supplying recommended champions to players based off of their masteries.
...
* **Stats (attack damage, magic damage, defense, and difficulty** This also lets people know more about the champions
...
* **Abilities** While this is useful to understanding how a champion might play, it seemed like too much information to display on the page, when the Summoner may or may not really understand what all of it means. It would also mean that the Summoner would have to wade through lots of information to get to their next recommendation. Instead, clicking on the champion brings you to their champion page on the League of Legends website.


**Fun and Delight**
The loading screen uses a Poro with hearts floating out of it.
![Poro loading](development/002.gif "Poro loading")
...
![Braum Error Message](development/003.png "Braum Error Message")
![Ryze Error Message](development/004.png "Ryze Error Message")
![Kindred Error Message](development/005.png "Kindred Error Message")
![Teemo Error Message](development/006.png "Teemo Error Message")
![Ezreal Error Message](development/007.png "Ezreal Error Message")
![Aurelion Sol Error Message](development/008.png "Aurelion Sol Error Message")
